...
interface NotesTabsOptionsProps {
  warningTitle?: string;
  onfirstPress: () => void;
  onSecondPress: () => void;
  onThirdPress: () => void;
...
const NotesTabsOptions = ({
  warningTitle,
  onfirstPress,
  onSecondPress,
  onThirdPress,
  selected = 1,
}: NotesTabsOptionsProps) => {
  return (
      ...
      <View style={{flexDirection: 'row'}}>
        ...
        <Pressable onPress={onThirdPress}>
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Text style={styles.title}>{Constants.summary}</Text>
            </View>
          </View>
        </Pressable>
...
export default NotesTabsOptions;
