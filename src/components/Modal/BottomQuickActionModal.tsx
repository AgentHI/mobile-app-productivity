...
interface BottomQucikActionModalProps {
  isVisible: boolean;
  onClose: () => void;
}


const BottomQucikActionModal = ({ isVisible, onClose }:BottomQucikActionModalProps) => {
      ...
      <View style={styles.bottomSheet}>
        <View style={styles.buttonContainer}>
          <TouchableOpacity  onPress={()=>createNewMeet()}  style={styles.createButton}>
            ...
            <Text style={styles.buttonText}>{Constants.CreateClient}</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => createNewReminder()} style={styles.createButton}>
            <BellSimple size={32} color="#4F4F4F" />
            <Text style={styles.buttonText}>{Constants.other}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
...
export default BottomQucikActionModal;
